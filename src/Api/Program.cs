...
builder.Services.AddSingleton<ITextAnomalyRequestParser, TextAnomalyRequestParser>();
...
builder.Services.AddSingleton<ITextAnomalyResponseMapper, TextAnomalyResponseMapper>();
...
builder.Services.AddScoped<IAnomalyScoringCore, AnomalyScoringCore>();
...
builder.Services.AddScoped<ITextAnomalyEndpointService, TextAnomalyEndpointService>();
